<?php
if(!class_exists('WPCC_autoptimize_cache')){
	class WPCC_autoptimize_cache extends wpcc_base{
		private $title = 'Autoptimize Cache';
		private $id = 'autoptimize';
		private $plugin = '';
