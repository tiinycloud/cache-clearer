<?php
if(!class_exists('WPCC_premium_addons_for_elementor_cache')){
	class WPCC_premium_addons_for_elementor_cache extends wpcc_base{
		private $title = 'Premium Addons for Elementor';
		private $id = 'premium-addons-for-elementor';
		private $plugin = '';
	...
	new WPCC_premium_addons_for_elementor_cache();
}