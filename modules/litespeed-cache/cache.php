<?php
if(!class_exists('WPCC_litespeed_cache')){
	class WPCC_litespeed_cache extends wpcc_base{
		private $title = 'LiteSpeed Cache';
		private $id = 'litespeed-cache';
		private $plugin = '';
