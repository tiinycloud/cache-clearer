<?php
if(!class_exists('WPCC_fastest_cache')){
	class WPCC_fastest_cache extends wpcc_base{
		private $title = 'WP Fastest Cache';
		private $id = 'wp-fastest-cache';
		private $plugin = '';
		function __construct() {
			global $cache_list;
			$this->plugin = $this->id.'/wpFastestCache.php';
