<?php
if(!class_exists('WPCC_siteground_supercacher')){
	class WPCC_siteground_supercacher extends wpcc_base{
		private $title = 'SiteGround SuperCacher';
		private $id = 'siteground-supercacher';
		private $plugin = '';
	...
	new WPCC_siteground_supercacher();
}