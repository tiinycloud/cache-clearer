<?php
if(!class_exists('WPCC_w3_total_cache')){
	class WPCC_w3_total_cache extends wpcc_base{
		private $title = 'W3 Total Cache';
		private $id = 'w3-total-cache';
		private $plugin = '';
