<?php
if(!class_exists('WPCC_super_cache')){
	class WPCC_super_cache extends wpcc_base{
		private $title = 'WP Super Cache';
		private $id = 'wp-super-cache';
		private $plugin = '';
		function __construct() {
			global $cache_list;
			$this->plugin = $this->id.'/wp-cache.php';
